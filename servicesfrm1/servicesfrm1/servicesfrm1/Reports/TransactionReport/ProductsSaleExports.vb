...
Public Class ProductsSaleExports
 ...
 Dim con As New SqlClient.SqlConnection
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button3.Click
        ...
        Dim strExportFile As String = "d:\ProductSaleReport.doc"
        ...
        objOptions = Nothing
        reportWord = Nothing
        MsgBox("Please Check your D Drive.There will be a File with the Name of ProductSaleReport.Please Copy and Paste it in other folder for record otherwise it will replace when you print new one")
    End Sub
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button2.Click
        ...
        Try
            ...
            Dim rprt As New ProductSaleReport 'The report you created.
            Dim myConnection As SqlConnection
            Dim MyCommand As New SqlCommand()
            Dim myDA As New SqlDataAdapter()
            Dim myDS As New mainclinicdbDataSet 'The DataSet you created.
            ...
            ProductSaleReportFrm.ProductSaleViewer1.ReportSource = rprt
    ...
    Private Sub ProductsSaleExports_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        wordconvert()
        Call CenterToScreen()
    End Sub
End Class